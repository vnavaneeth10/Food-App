    ...
    <div className="mx-auto">
      <div className="filter flex mx-auto">
        <div className="search m-4 p-4 ">
          ...
          <button className="px-4 py-2 bg-green-100 m-4 rounded-lg hover:bg-sky-200" onClick={()=> {
        ...
        <button className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-pink-200" onClick={() => {
